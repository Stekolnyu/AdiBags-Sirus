...
L["Check this to display an icon after usage of each type of bags."] = "Поставьте тут галочку для отображения иконки после использования каждого из видов сумок." 
...
L["Check this to show space at your bank in the plugin."] = "Отметьте это, если хотите чтобы отображались промежутки в окне банка вашего плагина."
...
L['Currencies to show'] = "Отображать валюту" -- currencyFrame.lua
L['Hide zeroes'] = "Прятать пустую валюту" -- currencyFrame.lua
L['Ignore currencies with null amounts.'] = "Игнорировать валюты с нулевым количеством" -- currencyFrame.lua
...
L['Items in this list are never considered as junk. Click an item to remove it from the list.'] = "Предметы в этом списке никогда не считаются ненужными. Щелкните по предмету, чтобы удалить его из списка."	--Junk.lua
L['Items in this list are always considered as junk. Click an item to remove it from the list.'] = "Предметы в этом списке всегда считаются ненужными. Щелкните по предмету, чтобы удалить его из списка."	--Junk.lua
L['Exclude list'] = "Убрать из списка"	--Junk.lua
L['Include list'] = "Включить в список" --Junk.lua
L['Included categories'] = "Включенные категории"	--Junk.lua
L['Junk category'] = "Категория хлама"	--Junk.lua
L['Low quality items'] = "Предметы низкого качества"	--Junk.lua
L["Display character currency at bottom left of the backpack."] = "Показывать количество валюты у персонажа в нижней левой стороне окна сумок." --CyrrencyFrame.lua
L['Right-click to configure.'] = "Кликните правой кнопкой, что бы открыть настройки." --CyrrencyFrame.lua
L["Display character money at bottom right of the backpack."] = "Отображать деньги персонажа в нижнем правом углу рюкзака." -- MoneyFrame.lua
...
L['Which color scheme should be used to display the item level ?'] = "Какую цветовую схему следует использовать для отображения уровня предметов?"
L['Color scheme'] = "Цветовая схема"
L['None'] = "Стандарт"
L['Same as InventoryItemLevels'] = "Зависимость цвета от уровня предметов"
L['Related to player level'] = "Зависимость от уровня персонажа"
L['Ignore heirloom items'] = "Игнорировать наследуемые предметы"
L['Only equippable items'] = "Отображать только у оснащаемых предметов"
...
L['Display the level of equippable item in the top left corner of the button.'] = "Отображать уровень предмета в верхнем левом углу предмета."
L["Merge free space"] = "Объединить свободное пространство"
L["Merge unstackable items"] = "Объединить нестакующиеся предметы(вроде не работает)"
L["Put decorated items in their own section."] = "Поместить предметы связанные с трансмогрификацией в свою секцию."
L["When trading:"] = "При трэйдинге:"
L["KEYRING_TAG"] = "Клч"
...
L["Provides a LDB data source to be displayed by LDB display addons."] = "Позволяет отображать источник LDB данных другими аддонами для отображения LDB." 
...
L["Select how bag usage should be formatted in the plugin."] = "Выберите способ, которым следует упорядочивать использование сумок плагином." 
...
L["Select the sections in which the items should be dispatched."] = "Укажите секцию, в которой вещи необходимо разделить" 
...
L["Use this section to define any item-section association."] = "Использовать эту секцию, для определения любой связной с ней секцией" 
